...
public class LazyAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		placeReference.setText(place.get(Mainmap.KEY_REFERENCE));
		placeName.setText(place.get(Mainmap.KEY_NAME));
		if(place.get(Mainmap.KEY_RATING) != null){
			placeRatingBar.setRating(Float.parseFloat(place.get(Mainmap.KEY_RATING)));
		}else{
			Log.d("rating", "rating null for "+place.get(Mainmap.KEY_NAME));
			placeRatingBar.setVisibility(View.GONE);
		}
		
		
		placeAddress.setText(place.get(Mainmap.KEY_ADDRESS));
		placeLatitude.setText(place.get(Mainmap.KEY_LATITUDE));
		placeLongitude.setText(place.get(Mainmap.KEY_LONGITUDE));
		distance.setText(place.get(Mainmap.KEY_DISTANCE)+" KM");
		...
		directionBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (gps.canGetLocation()) {
					...
					String dLat = currentPlace.get(Mainmap.KEY_LATITUDE);
					String dLong = currentPlace.get(Mainmap.KEY_LONGITUDE);
